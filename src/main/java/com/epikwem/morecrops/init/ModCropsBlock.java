...
public class ModCropsBlock extends CropsBlock {
    ...
    public static Item seedsItem;

    public ModCropsBlock( Item _seedsItem) {
        super( Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0F, 0.0F).sound(SoundType.CROP) );
        this.seedsItem = _seedsItem;
...
public class ModCropsBlock extends CropsBlock {
    ...
    public ModCropsBlock(String name, AbstractBlock.Properties builder) {
        super(builder);
        this.name = name;
    ...
    public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
        switch (name) {
            ...
            case "oat":
                return new ItemStack( ModItems.OAT_SEEDS ) ;
            case "hop":
                return new ItemStack( ModItems.HOP_SEEDS ) ;
            case "rye":
                return new ItemStack( ModItems.RYE_SEEDS ) ;
            default:
